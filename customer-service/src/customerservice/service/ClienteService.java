...
public class ClienteService {
    ...
    public Cliente registrar(FormularioRegistro request) {
        ...
        cliente.setRol(customerservice.models.Rol.CLIENTE);
    ...
    public void cambiarPassword(Long idCliente, FormularioCambioPassword request) {
        Cliente cliente = clienteRepository.findById(idCliente)
                .orElseThrow(() -> new IllegalArgumentException("Cliente no encontrado."));
        ...
        cliente.setPasswordHash(passwordEncoder.encode(request.getPasswordNuevo()));
