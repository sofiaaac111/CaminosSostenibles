...
import customerservice.schemas.FormularioCambioPassword;
...
public class ClienteController {
    ...
    @PutMapping("/{idCliente}/password")
    public ResponseEntity<String> cambiarPassword(@PathVariable Long idCliente,
                                                   @Valid @RequestBody FormularioCambioPassword request) {
        clienteService.cambiarPassword(idCliente, request);
