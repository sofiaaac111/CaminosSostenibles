package com.supermarket.erp.inventoryservice.controller;
...
import com.supermarket.erp.inventoryservice.service.InventarioService;
...
public class InventarioController {
    ...
    public ResponseEntity<ExistenciaProducto> agregarStock(
        ...
        ExistenciaProducto existencia = inventarioService.agregarStock(idProducto, numeroLote, cantidad, fechaVencimiento);
